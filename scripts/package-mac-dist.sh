...
# Output:
# - dist/clawbot.app
# - dist/clawbot-<version>.zip
# - dist/clawbot-<version>.dmg
...
ZIP="$ROOT_DIR/dist/clawbot-$VERSION.zip"
DMG="$ROOT_DIR/dist/clawbot-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/clawbot-$VERSION.notary.zip"
