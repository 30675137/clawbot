...
export CLAWDBOT_STATE_DIR="/tmp/clawbot-test"
export CLAWDBOT_CONFIG_PATH="${CLAWDBOT_STATE_DIR}/clawbot.json"
...
pnpm clawbot reset --scope config+creds+sessions --yes --non-interactive
...
pnpm clawbot uninstall --state --yes --non-interactive
