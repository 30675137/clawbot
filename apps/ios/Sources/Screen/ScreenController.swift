...
final class ScreenController {
    ...
    /// Callback invoked when a clawbot:// deep link is tapped in the canvas
    ...
    private static func bundledResourceURL(
        ...
        -> URL?
    {
        let bundle = clawbotKitResources.bundle
...
/// Handles navigation policy to intercept clawbot:// deep links from canvas
@MainActor
private final class ScreenNavigationDelegate: NSObject, WKNavigationDelegate {
        ...
        decisionHandler: @escaping @MainActor @Sendable (WKNavigationActionPolicy) -> Void)
    {
        ...
        // Intercept clawbot:// deep links
        if url.scheme == "clawbot" {
