...
final class LocationService: NSObject, CLLocationManagerDelegate {
    ...
    func ensureAuthorization(mode: clawbotLocationMode) async -> CLAuthorizationStatus {
    ...
    func currentLocation(
        params: clawbotLocationGetParams,
    ...
    private static func accuracyValue(_ accuracy: clawbotLocationAccuracy) -> CLLocationAccuracy {
        switch accuracy {
        case .coarse:
