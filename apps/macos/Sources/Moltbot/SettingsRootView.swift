...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .clawbotSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? clawbotPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? clawbotPaths.stateDirURL.path
...
extension Notification.Name {
    static let clawbotSelectSettingsTab = Notification.Name("clawbotSelectSettingsTab")
}
