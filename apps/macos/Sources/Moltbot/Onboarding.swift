...
enum UIStrings {
    static let welcomeTitle = "Welcome to clawbot"
}
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: clawbotOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: clawbotChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g clawbot@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: clawbotChatViewModel(
