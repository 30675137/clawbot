...
final class PeekabooBridgeHostCoordinator {
    ...
    private var services: clawbotPeekabooBridgeServices?
    ...
    private func startIfNeeded() async {
        ...
        let services = clawbotPeekabooBridgeServices()
...
@MainActor
private final class clawbotPeekabooBridgeServices: PeekabooBridgeServiceProviding {
