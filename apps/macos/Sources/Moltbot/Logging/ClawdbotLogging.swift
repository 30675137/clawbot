...
enum clawbotLogging {
    ...
    private static let didBootstrap: Void = {
        LoggingSystem.bootstrap { label in
            ...
            let osHandler = clawbotOSLogHandler(subsystem: subsystem, category: category)
            let fileHandler = clawbotFileLogHandler(label: label)
...
extension Logging.Logger {
    init(subsystem: String, category: String) {
        clawbotLogging.bootstrapIfNeeded()
        let label = clawbotLogging.makeLabel(subsystem: subsystem, category: category)
...
struct clawbotOSLogHandler: LogHandler {
...
struct clawbotFileLogHandler: LogHandler {
    let label: String
    var metadata: Logger.Metadata = [:]
        ...
        line: UInt)
    {
        ...
        let (subsystem, category) = clawbotLogging.parseLabel(self.label)
