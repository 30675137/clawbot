...
@MainActor
public struct clawbotChatView: View {
    public enum Style {
        case standard
        case onboarding
    }

    @State private var viewModel: clawbotChatViewModel
    ...
    public init(
        viewModel: clawbotChatViewModel,
    ...
    private var visibleMessages: [clawbotChatMessage] {
        let base: [clawbotChatMessage]
    ...
    private func mergeToolResults(in messages: [clawbotChatMessage]) -> [clawbotChatMessage] {
    ...
    private func isToolResultMessage(_ message: clawbotChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: clawbotChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: clawbotChatMessage) -> String {
