...
public typealias clawbotPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias clawbotPlatformImage = UIImage
#endif

public struct clawbotChatUsageCost: Codable, Hashable, Sendable {
...
public struct clawbotChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: clawbotChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(clawbotChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct clawbotChatMessageContent: Codable, Hashable, Sendable {
...
public struct clawbotChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [clawbotChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: clawbotChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [clawbotChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: clawbotChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(clawbotChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([clawbotChatMessageContent].self, forKey: .content) {
...
public struct clawbotChatHistoryPayload: Codable, Sendable {
...
public struct clawbotSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct clawbotSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [clawbotSessionPreviewItem]
}

public struct clawbotSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [clawbotSessionPreviewEntry]

    public init(ts: Int, previews: [clawbotSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct clawbotChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct clawbotChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct clawbotAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct clawbotChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct clawbotGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct clawbotPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: clawbotPlatformImage?
...
public struct clawbotChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
