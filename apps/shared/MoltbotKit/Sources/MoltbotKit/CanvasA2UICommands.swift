...
public enum clawbotCanvasA2UICommand: String, Codable, Sendable {
...
public struct clawbotCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct clawbotCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
