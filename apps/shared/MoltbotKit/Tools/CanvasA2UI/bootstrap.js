...
import "@a2ui/lit/ui";
import { themeContext } from "@clawbot/a2ui-theme-context";
...
class clawbotA2UIHost extends LitElement {
  static properties = {
    surfaces: { state: true },
  ...
  static styles = css`
    :host {
      ...
      padding:
        var(--clawbot-a2ui-inset-top, 0px)
        var(--clawbot-a2ui-inset-right, 0px)
        var(--clawbot-a2ui-inset-bottom, 0px)
        var(--clawbot-a2ui-inset-left, 0px);
    }
    ...
    #surfaces {
      ...
      height: 100%;
      overflow: auto;
      padding-bottom: var(--clawbot-a2ui-scroll-pad-bottom, 0px);
    }
    ...
    .status {
      ...
      top: var(--clawbot-a2ui-status-top, 12px);
      display: inline-flex;
      align-items: center;
      gap: 8px;
      padding: 8px 10px;
    ...
    .toast {
      ...
      left: 50%;
      transform: translateX(-50%);
      bottom: var(--clawbot-a2ui-toast-bottom, 12px);
      display: inline-flex;
      align-items: center;
      gap: 8px;
      padding: 8px 10px;
    ...
    .empty {
      ...
      left: 50%;
      transform: translateX(-50%);
      top: var(--clawbot-a2ui-empty-top, var(--clawbot-a2ui-status-top, 12px));
      text-align: center;
      opacity: 0.8;
      padding: 10px 12px;
      pointer-events: none;
  ...
  connectedCallback() {
    ...
    globalThis.clawbotA2UI = api;
    globalThis.clawdbotA2UI = api;
    this.addEventListener("a2uiaction", (evt) => this.#handleA2UIAction(evt));
    this.#statusListener = (evt) => this.#handleActionStatus(evt);
    globalThis.addEventListener("clawbot:a2ui-action-status", this.#statusListener);
    this.#syncSurfaces();
  }
  ...
  disconnectedCallback() {
    ...
    if (this.#statusListener) {
      globalThis.removeEventListener("clawbot:a2ui-action-status", this.#statusListener);
  ...
  #handleA2UIAction(evt) {
    ...
    globalThis.__clawbotLastA2UIAction = userAction;

    const handler =
      globalThis.webkit?.messageHandlers?.clawbotCanvasA2UIAction ??
      globalThis.webkit?.messageHandlers?.clawdbotCanvasA2UIAction ??
      globalThis.clawbotCanvasA2UIAction ??
    ...
    if (handler?.postMessage) {
      try {
        ...
        if (
          handler === globalThis.clawbotCanvasA2UIAction ||
...
customElements.define("clawbot-a2ui-host", clawbotA2UIHost);
