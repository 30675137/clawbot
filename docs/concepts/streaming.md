...
clawbot has two separate “streaming” layers:
...
When block streaming is enabled, clawbot can **merge consecutive block chunks**
...
When draft streaming is active, clawbot disables block streaming for that reply to avoid double-streaming.
