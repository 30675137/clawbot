---
summary: "Use MiniMax M2.1 in clawbot"
read_when:
  - You want MiniMax models in clawbot
...
Configure manually via `clawbot.json`:
...
- Use `clawbot models list` and `clawbot models set minimax/MiniMax-M2.1` to switch.
...
- Running `clawbot configure` and selecting **MiniMax M2.1**, or
