...
You can point clawbot at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or clawbot
...
- [Anthropic provider](/providers/anthropic) - Native clawbot integration with Claude setup-token or API keys
