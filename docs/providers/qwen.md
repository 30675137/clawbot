---
summary: "Use Qwen OAuth (free tier) in clawbot"
read_when:
  - You want to use Qwen with clawbot
...
```bash
clawbot models set qwen-portal/coder-model
```

## Reuse Qwen Code CLI login

If you already logged in with the Qwen Code CLI, clawbot will sync credentials
