...
read_when:
  - Installing clawbot on Windows
  - Looking for Windows companion app status
---
# Windows (WSL2)

clawbot on Windows is recommended **via WSL2** (Ubuntu recommended). The
