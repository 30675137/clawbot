...
summary: Machine-checked security models for clawbot’s highest-risk paths.
permalink: /security/formal-verification/
---

# Formal Verification (Security Models)

This page tracks clawbot’s **formal security models** (TLA+/TLC today; more as needed).

> Note: some older links may refer to the previous project name.

**Goal (north star):** provide a machine-checked argument that clawbot enforces its
...
**What this is not (yet):** a proof that “clawbot is secure in all respects” or that the full TypeScript implementation is correct.
