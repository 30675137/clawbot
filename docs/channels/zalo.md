...
- Install via CLI: `clawbot plugins install @clawbot/zalo`
- Or select **Zalo** during onboarding and confirm the install prompt
- Details: [Plugins](/plugin)

## Quick setup (beginner)
1) Install the Zalo plugin:
   - From a source checkout: `clawbot plugins install ./extensions/zalo`
   - From npm (if published): `clawbot plugins install @clawbot/zalo`
...
- Approve via:
  - `clawbot pairing list zalo`
  - `clawbot pairing approve zalo <CODE>`
...
- Example: `clawbot message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**
- Check that the token is valid: `clawbot channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `clawbot logs --follow`
