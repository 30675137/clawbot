...
export function listBindings(cfg: clawbotConfig): AgentBinding[] {
  return Array.isArray(cfg.bindings) ? cfg.bindings : [];
}

export function listBoundAccountIds(cfg: clawbotConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: clawbotConfig) {
