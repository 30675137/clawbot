...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof clawbotConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: clawbotConfig; env: NodeJS.ProcessEnv }): {
  cfg: clawbotConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
