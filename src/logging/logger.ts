...
export const DEFAULT_LOG_DIR = "/tmp/clawbot";
export const DEFAULT_LOG_FILE = path.join(DEFAULT_LOG_DIR, "clawbot.log"); // legacy single-file path

const LOG_PREFIX = "clawbot";
...
function resolveSettings(): ResolvedSettings {
  let cfg: clawbotConfig["logging"] | undefined =
    (loggingState.overrideSettings as LoggerSettings | null) ?? readLoggingConfig();
  if (!cfg) {
    try {
      const loaded = requireConfig("../config/config.js") as {
        loadConfig?: () => clawbotConfig;
      };
