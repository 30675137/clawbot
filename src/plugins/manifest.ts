...
export const PLUGIN_MANIFEST_FILENAME = "clawbot.plugin.json";
...
// package.json "clawbot" metadata (used for onboarding/catalog)
...
export type clawbotPackageManifest = {
  extensions?: string[];
...
): clawbotPackageManifest | undefined {
  if (!manifest) return undefined;
  return manifest.clawbot ?? manifest[LEGACY_MANIFEST_KEY];
}
