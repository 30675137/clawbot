...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @clawbot/voice-call -> voice-call).
...
function addCandidate(params: {
  ...
  params.candidates.push({
    ...
    packageclawbot: getPackageManifestMetadata(manifest ?? undefined),
  });
}
...
export function discoverclawbotPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
