import type { BrowserConfig, BrowserProfileConfig, clawbotConfig } from "../config/config.js";
import {
 ...
 *
 * Note: this is a clawbot browser profile (routing config), not a Chrome user profile.
