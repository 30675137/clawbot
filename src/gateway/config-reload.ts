...
import type { clawbotConfig, ConfigFileSnapshot, GatewayReloadMode } from "../config/config.js";
...
export function resolveGatewayReloadSettings(cfg: clawbotConfig): GatewayReloadSettings {
...
export function startGatewayConfigReloader(opts: {
  initialConfig: clawbotConfig;
  readSnapshot: () => Promise<ConfigFileSnapshot>;
  onHotReload: (plan: GatewayReloadPlan, nextConfig: clawbotConfig) => Promise<void>;
  onRestart: (plan: GatewayReloadPlan, nextConfig: clawbotConfig) => void;
  log: {
