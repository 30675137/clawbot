...
import { type clawbotConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: clawbotConfig): string[] {
...
export function listAgentsForGateway(cfg: clawbotConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: clawbotConfig): string {
  return normalizeAgentId(resolveDefaultAgentId(cfg));
}

export function resolveSessionStoreKey(params: { cfg: clawbotConfig; sessionKey: string }): string {
...
function resolveSessionStoreAgentId(cfg: clawbotConfig, canonicalKey: string): string {
...
export function resolveGatewaySessionStoreTarget(params: { cfg: clawbotConfig; key: string }): {
  agentId: string;
  storePath: string;
  canonicalKey: string;
  storeKeys: string[];
...
export function loadCombinedSessionStoreForGateway(cfg: clawbotConfig): {
  storePath: string;
...
export function getSessionDefaults(cfg: clawbotConfig): GatewaySessionsDefaults {
