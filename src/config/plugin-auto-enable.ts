...
function isTelegramConfigured(cfg: clawbotConfig, env: NodeJS.ProcessEnv): boolean {
...
function isDiscordConfigured(cfg: clawbotConfig, env: NodeJS.ProcessEnv): boolean {
...
function isSlackConfigured(cfg: clawbotConfig, env: NodeJS.ProcessEnv): boolean {
  if (
...
function isSignalConfigured(cfg: clawbotConfig): boolean {
...
function isIMessageConfigured(cfg: clawbotConfig): boolean {
...
function isWhatsAppConfigured(cfg: clawbotConfig): boolean {
...
function isGenericChannelConfigured(cfg: clawbotConfig, channelId: string): boolean {
...
function collectModelRefs(cfg: clawbotConfig): string[] {
  const refs: string[] = [];
...
function isProviderConfigured(cfg: clawbotConfig, providerId: string): boolean {
...
function isPluginExplicitlyDisabled(cfg: clawbotConfig, pluginId: string): boolean {
  const entry = cfg.plugins?.entries?.[pluginId];
  return entry?.enabled === false;
}

function isPluginDenied(cfg: clawbotConfig, pluginId: string): boolean {
...
function ensureAllowlisted(cfg: clawbotConfig, pluginId: string): clawbotConfig {
...
function enablePluginEntry(cfg: clawbotConfig, pluginId: string): clawbotConfig {
  const entries = {
    ...cfg.plugins?.entries,
    [pluginId]: {
