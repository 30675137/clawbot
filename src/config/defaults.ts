...
function resolveAnthropicDefaultAuthMode(cfg: clawbotConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: clawbotConfig): clawbotConfig {
...
export function applyTalkApiKey(config: clawbotConfig): clawbotConfig {
...
export function applyModelDefaults(cfg: clawbotConfig): clawbotConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: clawbotConfig): clawbotConfig {
...
export function applyLoggingDefaults(cfg: clawbotConfig): clawbotConfig {
...
export function applyContextPruningDefaults(cfg: clawbotConfig): clawbotConfig {
...
export function applyCompactionDefaults(cfg: clawbotConfig): clawbotConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) return cfg;
