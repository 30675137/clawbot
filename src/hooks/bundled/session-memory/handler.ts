...
const saveSessionToMemory: HookHandler = async (event) => {
  ...
  try {
    ...
    const cfg = context.cfg as clawbotConfig | undefined;
    ...
    if (sessionFile) {
      ...
      if (sessionContent && cfg) {
        ...
        const clawbotRoot = path.resolve(path.dirname(fileURLToPath(import.meta.url)), "../..");
        const slugGenPath = path.join(clawbotRoot, "llm-slug-generator.js");
