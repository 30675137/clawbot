...
export type ChannelAgentToolFactory = (params: { cfg?: clawbotConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: clawbotConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: clawbotConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: clawbotConfig }) => boolean;
  supportsCards?: (params: { cfg: clawbotConfig }) => boolean;
