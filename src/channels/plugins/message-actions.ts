...
export function listChannelMessageActions(cfg: clawbotConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: clawbotConfig): boolean {
  for (const plugin of listChannelPlugins()) {
...
export function supportsChannelMessageCards(cfg: clawbotConfig): boolean {
  for (const plugin of listChannelPlugins()) {
