import type { clawbotConfig } from "../config/types.js";
...
export function isCommandEnabled(cfg: clawbotConfig, commandKey: string): boolean {
...
function resolveDefaultCommandContext(cfg?: clawbotConfig): {
  provider: string;
  model: string;
} {
...
export function getCommandDetection(_cfg?: clawbotConfig): CommandDetection {
  const commands = getChatCommands();
...
export function maybeResolveTextAlias(raw: string, cfg?: clawbotConfig) {
