...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@clawbot", { botUsername: "clawbot" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@clawbot args", {
        botUsername: "clawbot",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "clawbot" })).toBe(
      "/help@otherbot",
    );
  });
