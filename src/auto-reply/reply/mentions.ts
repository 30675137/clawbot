...
function resolveMentionPatterns(cfg: clawbotConfig | undefined, agentId?: string): string[] {
  if (!cfg) return [];
...
export function buildMentionRegexes(cfg: clawbotConfig | undefined, agentId?: string): RegExp[] {
