...
async function withTempHome<T>(fn: (home: string) => Promise<T>): Promise<T> {
  return withTempHomeBase(fn, { prefix: "clawbot-agent-" });
}

function mockConfig(
  home: string,
  storePath: string,
  agentOverrides?: Partial<NonNullable<NonNullable<clawbotConfig["agents"]>["defaults"]>>,
  telegramOverrides?: Partial<NonNullable<clawbotConfig["telegram"]>>,
