...
export async function updateConfig(
  mutator: (cfg: clawbotConfig) => clawbotConfig,
...
export function resolveModelTarget(params: { raw: string; cfg: clawbotConfig }): {
  provider: string;
  model: string;
} {
...
export function buildAllowlistSet(cfg: clawbotConfig): Set<string> {
