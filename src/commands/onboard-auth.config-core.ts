...
export function applyZaiConfig(cfg: clawbotConfig): clawbotConfig {
...
export function applyOpenrouterProviderConfig(cfg: clawbotConfig): clawbotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayProviderConfig(cfg: clawbotConfig): clawbotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayConfig(cfg: clawbotConfig): clawbotConfig {
...
export function applyOpenrouterConfig(cfg: clawbotConfig): clawbotConfig {
...
export function applyMoonshotProviderConfig(cfg: clawbotConfig): clawbotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyMoonshotConfig(cfg: clawbotConfig): clawbotConfig {
...
export function applyKimiCodeProviderConfig(cfg: clawbotConfig): clawbotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: clawbotConfig): clawbotConfig {
...
export function applySyntheticProviderConfig(cfg: clawbotConfig): clawbotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: clawbotConfig): clawbotConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: clawbotConfig): clawbotConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: clawbotConfig): clawbotConfig {
