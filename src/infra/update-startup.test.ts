...
describe("update-startup", () => {
  ...
  beforeEach(async () => {
    ...
    tempDir = await fs.mkdtemp(path.join(os.tmpdir(), "clawbot-update-check-"));
  ...
  it("logs update hint for npm installs when newer tag exists", async () => {
    const { resolveclawbotPackageRoot } = await import("./clawbot-root.js");
    ...
    vi.mocked(resolveclawbotPackageRoot).mockResolvedValue("/opt/clawbot");
