...
export class DirectoryCache<T> {
  ...
  private lastConfigRef: clawbotConfig | null = null;

  constructor(private readonly ttlMs: number) {}

  get(key: string, cfg: clawbotConfig): T | undefined {
  ...
  set(key: string, value: T, cfg: clawbotConfig): void {
    this.resetIfConfigChanged(cfg);
  ...
  clear(cfg?: clawbotConfig): void {
    this.cache.clear();
    if (cfg) this.lastConfigRef = cfg;
  }

  private resetIfConfigChanged(cfg: clawbotConfig): void {
