...
function resolveMainSessionKeyForSandbox(params: { cfg?: clawbotConfig; agentId: string }): string {
...
export function resolveSandboxRuntimeStatus(params: { cfg?: clawbotConfig; sessionKey?: string }): {
  agentId: string;
  sessionKey: string;
...
export function formatSandboxToolPolicyBlockedMessage(params: {
  ...
  lines.push(
    `- See: ${formatCliCommand(`clawbot sandbox explain --session ${runtime.sessionKey}`)}`,
  );
