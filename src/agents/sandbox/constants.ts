...
export const DEFAULT_SANDBOX_IMAGE = "clawbot-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "clawbot-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "clawbot-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "clawbot-sandbox-common:bookworm-slim";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "clawbot-sbx-browser-";
