...
describe("createclawbotCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createclawbotCodingTools({
      config,
    ...
    const anthropicTools = createclawbotCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createclawbotCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createclawbotCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
