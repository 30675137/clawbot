...
function resolveAvatarSource(cfg: clawbotConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: clawbotConfig, agentId: string): AgentAvatarResolution {
