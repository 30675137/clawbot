...
import type { clawbotConfig, SkillConfig } from "../../config/config.js";
...
export function resolveConfigPath(config: clawbotConfig | undefined, pathStr: string) {
...
export function isConfigPathTruthy(config: clawbotConfig | undefined, pathStr: string): boolean {
...
export function resolveSkillConfig(
  config: clawbotConfig | undefined,
  skillKey: string,
...
function isBundledSkill(entry: SkillEntry): boolean {
  return entry.skill.source === "clawbot-bundled";
}

export function resolveBundledAllowlist(config?: clawbotConfig): string[] | undefined {
