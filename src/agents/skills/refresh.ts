...
function resolveWatchPaths(workspaceDir: string, config?: clawbotConfig): string[] {
  const paths: string[] = [];
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: clawbotConfig }) {
