...
function resolveExecConfig(cfg: clawbotConfig | undefined) {
...
export function createclawbotCodingTools(options?: {
  ...
  const base = (codingTools as unknown as AnyAgentTool[]).flatMap((tool) => {
    if (tool.name === readTool.name) {
      ...
      return [createclawbotReadTool(freshReadTool)];
    }
