...
${formatHelpExamples([
  ['clawbot agent --to +15555550123 --message "status update"', "Start a new session."],
  ['clawbot agent --agent ops --message "Summarize logs"', "Use a specific agent."],
  [
    'clawbot agent --session-id 1234 --message "Summarize inbox" --thinking medium',
    "Target a session with explicit thinking level.",
  ],
  [
    'clawbot agent --to +15555550123 --message "Trace logs" --verbose on --json',
    "Enable verbose logging and JSON output.",
  ],
  ['clawbot agent --to +15555550123 --message "Summon reply" --deliver', "Deliver reply."],
  [
...
${theme.heading("Examples:")}
${formatHelpExamples([
  ['clawbot agents set-identity --agent main --name "Clawd" --emoji "🦞"', "Set name + emoji."],
  ["clawbot agents set-identity --agent main --avatar avatars/clawd.png", "Set avatar path."],
  ["clawbot agents set-identity --workspace ~/clawd --from-identity", "Load from IDENTITY.md."],
  [
    "clawbot agents set-identity --identity-file ~/clawd/IDENTITY.md --agent main",
