...
const SANDBOX_EXAMPLES = {
  main: [
    ["clawbot sandbox list", "List all sandbox containers."],
    ["clawbot sandbox list --browser", "List only browser containers."],
    ["clawbot sandbox recreate --all", "Recreate all containers."],
    ["clawbot sandbox recreate --session main", "Recreate a specific session."],
    ["clawbot sandbox recreate --agent mybot", "Recreate agent containers."],
    ["clawbot sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["clawbot sandbox list", "List all sandbox containers."],
    ["clawbot sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ["clawbot sandbox recreate --all", "Recreate all containers."],
    ["clawbot sandbox recreate --session main", "Recreate a specific session."],
    ["clawbot sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["clawbot sandbox recreate --browser --all", "Recreate only browser containers."],
    ["clawbot sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["clawbot sandbox explain", "Show effective sandbox config."],
    ["clawbot sandbox explain --session agent:main:main", "Explain a specific session."],
    ["clawbot sandbox explain --agent work", "Explain an agent sandbox."],
    ["clawbot sandbox explain --json", "JSON output."],
  ],
} as const;
