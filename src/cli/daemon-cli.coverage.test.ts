...
describe("daemon-cli coverage", () => {
  ...
  beforeEach(() => {
    process.env.CLAWDBOT_STATE_DIR = "/tmp/clawbot-cli-state";
    process.env.CLAWDBOT_CONFIG_PATH = "/tmp/clawbot-cli-state/clawbot.json";
  ...
  it("derives probe URL from service args + env (json)", async () => {
    ...
    serviceReadCommand.mockResolvedValueOnce({
      ...
      environment: {
        ...
        CLAWDBOT_STATE_DIR: "/tmp/clawbot-daemon-state",
        CLAWDBOT_CONFIG_PATH: "/tmp/clawbot-daemon-state/clawbot.json",
