...
export const A2UI_PATH = "/__clawbot__/a2ui";
export const CANVAS_HOST_PATH = "/__clawbot__/canvas";
export const CANVAS_WS_PATH = "/__clawbot/ws";
...
(() => {
  ...
  const handlerNames = ["clawbotCanvasA2UIAction", "${legacyHandlerName}"];
  ...
  globalThis.clawbot = globalThis.clawbot ?? {};
  globalThis.clawbot.postMessage = postToNode;
  globalThis.clawbot.sendUserAction = sendUserAction;
  globalThis.clawbotPostMessage = postToNode;
  globalThis.clawbotSendUserAction = sendUserAction;
