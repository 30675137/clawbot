...
### Changes
- Version alignment with core clawbot release numbers.
...
### Highlights
- First public release of the @clawbot/voice-call plugin.
...
- CLI: `clawbot voicecall` commands (call/start/continue/speak/end/status/tail/expose).
